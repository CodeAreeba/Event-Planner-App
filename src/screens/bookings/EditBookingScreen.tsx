...
const parseTimeToDate = (timeString: string): Date => {
  const date = new Date();
  // Use regex to split on any whitespace character
      ...
      <ScrollView showsVerticalScrollIndicator={false} className="flex-1 mt-4 px-6">
        ...
        <View className="mb-4">
          <Text className="text-gray-700 text-sm font-semibold mb-2">
            Service Name <Text className="text-gray-400">(Read-only)</Text>
          </Text>
          <View className="flex-row items-center bg-gray-100 rounded-xl px-4 py-3 border border-gray-200">
            ...
            />
            <Text className="flex-1 text-gray-500 text-sm">{serviceName}</Text>
          </View>
        </View>
        ...
        <View className="mb-4">
          <Text className="text-gray-700 text-sm font-semibold mb-2">
            Customer Name <Text className="text-gray-400">(Read-only)</Text>
          </Text>
          <View className="flex-row items-center bg-gray-100 rounded-xl px-4 py-3 border border-gray-200">
            <Ionicons
              name="person-outline"
              ...
              style={{ marginRight: 12 }}
            />
            <Text className="flex-1 text-gray-500 text-sm">{userName}</Text>
          </View>
        </View>
        ...
        <View className="mb-4">
          <Text className="text-gray-700 text-sm font-semibold mb-2">
            Price <Text className="text-gray-400">(Read-only)</Text>
          </Text>
          <View className="flex-row items-center bg-gray-100 rounded-xl px-4 py-3 border border-gray-200">
            <Ionicons
              name="cash-outline"
        ...
        {/* Show warning if booking cannot be edited */}
        {!canEdit && (
          <View className="bg-yellow-50 border border-yellow-200 rounded-xl p-4 mb-4">
            <View className="flex-row items-center">
              ...
              <Text className="text-yellow-800 font-semibold flex-1">
                This booking cannot be edited because it has been {status}.
              </Text>
            </View>
          </View>
        )}
